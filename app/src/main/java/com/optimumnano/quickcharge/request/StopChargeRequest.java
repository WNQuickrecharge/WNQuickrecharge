...
public class StopChargeRequest extends BaseChargeRequest {
    private String order_no;

    public StopChargeRequest(BaseResult result,String order_no) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.stop_charge);
    }
