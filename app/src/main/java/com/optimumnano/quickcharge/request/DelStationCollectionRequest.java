...
public class DelStationCollectionRequest extends BaseChargeRequest {
    private int stationId;

    public DelStationCollectionRequest(BaseResult result, int stationId) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.delete_collection);
    }
