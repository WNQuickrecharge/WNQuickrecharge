...
public class CancelOrderRequest extends BaseChargeRequest {
    private String order_no;

    public CancelOrderRequest(BaseResult result, String order_no) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.cancel_order);
    }
