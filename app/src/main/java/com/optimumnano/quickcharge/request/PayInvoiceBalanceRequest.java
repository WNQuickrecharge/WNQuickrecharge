...
public class PayInvoiceBalanceRequest extends BaseChargeRequest {

    private String order_no;
    private double pay_cash;

    public PayInvoiceBalanceRequest(BaseResult result, String order_no, double pay_cash) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.pay_invoice_balance);
    }
