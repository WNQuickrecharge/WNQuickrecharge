...
public class DeleteOrderRequest extends BaseChargeRequest {
    private String order_no;

    public DeleteOrderRequest(BaseResult result, String order_no) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.delete_order);
    }
