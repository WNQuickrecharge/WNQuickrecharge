...
public class ForgetLoginPwdRequest extends BaseChargeRequest {
    ...
    public ForgetLoginPwdRequest(BaseResult result, String mobile, String purpose, String validate_code, String newpwd, int userType) {
        super(result);
        this.mobile = mobile;
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.forget_password_url);
    }
