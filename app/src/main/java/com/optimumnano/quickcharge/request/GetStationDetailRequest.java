...
public class GetStationDetailRequest extends BaseChargeRequest {
    private int stationId;

    public GetStationDetailRequest(BaseResult result, int stationId) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.get_station_detail);
    }
