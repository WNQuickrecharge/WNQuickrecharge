...
public class GetMapNearCarInfoRequest extends BaseChargeRequest {
    private PreferencesHelper mHelper;

    public GetMapNearCarInfoRequest(BaseResult result, PreferencesHelper helper) {
        super(result);
        mHelper = helper;
    }
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.region_carpile);
    }
