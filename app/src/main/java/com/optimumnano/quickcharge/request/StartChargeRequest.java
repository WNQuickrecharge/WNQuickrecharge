...
public class StartChargeRequest extends BaseChargeRequest {
    private String order_no;

    public StartChargeRequest(BaseResult result, String order_no) {
        super(result);
    ...
    protected String getUrl() {
        return HttpApi.getInstance().getUrl(HttpApi.start_charge);
    }
