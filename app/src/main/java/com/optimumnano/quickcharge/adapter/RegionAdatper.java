...
public class RegionAdatper extends RecyclerView.Adapter<RegionAdatper.ViewHolder> {


    private final List<DistShowPopupWindow.TypeSelect> mValues;
    private final OnListClickListener mListener;


    public RegionAdatper(List<DistShowPopupWindow.TypeSelect> mValues, OnListClickListener mListener) {
...
//                holder.mItem.isSelect=true;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.tv_region)
        TextView tvRegion;
        public DistShowPopupWindow.TypeSelect mItem;
