...
//    private static final String baseUrl = "http://112.74.44.166:4840/";//正常测试
//    private static final String baseUrl = "http://172.200.31.57:4840/";//临时测试
    private static final String baseUrl = "http://120.77.149.109:4720/";//正式库
    ...
    public static final String balance_deposit_url = "capp/order/add_deposit";//上传支付金额获取调起支付宝的orderInfo
    public static final String balance_deposit_url1 = "capp/user/get_accountinfo";//获取账户信息
